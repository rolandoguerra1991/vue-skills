...
- Combine with [vue-form-validation](../vue-form-validation/SKILL.md) for dynamic validators.
- Avoid in basic components; use direct imports.
- Testing: Simplifies mocks in [vue-unit-testing](../vue-unit-testing/SKILL.md).
