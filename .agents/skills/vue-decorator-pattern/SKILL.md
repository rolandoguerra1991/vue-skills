...
- Combine with [vue-composables-standard](../vue-composables-standard/SKILL.md) to extend logic.
- Avoid in simple components; use computed or watchers.
- Testing: Allows isolating decorators in [vue-unit-testing](../vue-unit-testing/SKILL.md).
