...
> [!IMPORTANT]
> This skill extends [vue-architecture-roles.md](./vue-architecture-roles.md) and [vue-component-standard.md](./vue-component-standard.md). Those files define component roles and file structure; this file defines **when and how to decompose** components into reusable atoms.
...
| **Pages** | Orchestrators that inject data | `src/views/` or `src/pages/` | Follow [vue-architecture-roles.md](./vue-architecture-roles.md) |
...
- All components follow the directory structure defined in [vue-component-standard.md](./vue-component-standard.md).
...
- **Organisms** may use composables and stores but must follow [vue-coding-standards.md](./vue-coding-standards.md) SOLID rules.
...
└── organisms/
    └── UserCard/
        └── ...
```
> Each component directory follows [vue-component-standard.md](./vue-component-standard.md).
