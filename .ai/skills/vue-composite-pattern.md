...
- Combine with [vue-atomic-design.md](./vue-atomic-design.md) for organism hierarchies.
- Avoid in simple lists; use direct v-for.
- Testing: Facilitates recursive tests in [vue-unit-testing.md](./vue-unit-testing.md).
