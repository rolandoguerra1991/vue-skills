...
- **Implementation:** Follow the "Setup Store" conventions defined in [vue-state-management](../vue-state-management/SKILL.md).

## Decision Matrix

| Scenario | Mechanism | Skill Reference |
|---|---|---|
| Parent ↔ Direct Child | Props + Emits | [vue-typescript-rules](../vue-typescript-rules/SKILL.md) |
| Grandparent → Deep Descendant | Provide / Inject with `InjectionKey` | This file §2 |
| Shared across unrelated views | Pinia Store | [vue-state-management](../vue-state-management/SKILL.md) |
