...
## Standard Alignment
- **Architecture:** Components/Views must follow the [Architectural Roles](../vue-architecture-roles/SKILL.md).
- **Styles:** Follow the [Styling Standards](../vue-styling-standards/SKILL.md) (BEM + Tailwind v4).
- **Testing:** Follow the [Unit Testing Standards](../vue-unit-testing/SKILL.md) (Vitest).
- **Coding:** Follow the [Coding Standards](../vue-coding-standards/SKILL.md) (<script setup> + SOLID).
...
- **BEM:** The main block class must match the component name in kebab-case. See [vue-styling-standards](../vue-styling-standards/SKILL.md) for full BEM rules.