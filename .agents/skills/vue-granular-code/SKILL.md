...
> [!IMPORTANT]
> This skill complements [vue-coding-standards](../vue-coding-standards/SKILL.md) (SOLID) and [vue-composables-standard](../vue-composables-standard/SKILL.md) (SRP for composables). Those files define **what** to separate; this file defines **how small** each unit must be.
...
- Refer to [vue-composables-standard](../vue-composables-standard/SKILL.md) for composable conventions.
