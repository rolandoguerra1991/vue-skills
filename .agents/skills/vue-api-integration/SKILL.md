...
> [!IMPORTANT]
> **Dependencies:** `axios` (See [vue-project-setup](../vue-project-setup/SKILL.md))
...
- **Mandatory:** Do not use `any` — see [vue-typescript-rules](../vue-typescript-rules/SKILL.md) (canonical).
